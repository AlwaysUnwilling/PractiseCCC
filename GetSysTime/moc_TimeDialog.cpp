...
QT_MOC_LITERAL(1, 11, 9), // "mySignals"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7) // "getTime"

    },
    "TimeDialog\0mySignals\0\0getTime"
};
...
void TimeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mySignals((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeDialog::mySignals)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TimeDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_TimeDialog.data,
