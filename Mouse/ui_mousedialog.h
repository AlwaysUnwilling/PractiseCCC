...
public:
    ...
    void setupUi(QDialog *MouseDialog)
    {
        ...
        MouseDialog->resize(800, 600);
        label = new QLabel(MouseDialog);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(60, 80, 161, 131));
        QPalette palette;
        ...
        QBrush brush2(QColor(255, 249, 203, 255));
        brush2.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Light, brush2);
        QBrush brush3(QColor(253, 241, 141, 255));
        brush3.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Midlight, brush3);
        QBrush brush4(QColor(126, 116, 40, 255));
        brush4.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Dark, brush4);
        QBrush brush5(QColor(168, 155, 53, 255));
        ...
        QBrush brush7(QColor(253, 244, 167, 255));
    ...
    void retranslateUi(QDialog *MouseDialog)
    {
        ...
        label->setText(QApplication::translate("MouseDialog", "TextLabel", nullptr));
    } // retranslateUi
